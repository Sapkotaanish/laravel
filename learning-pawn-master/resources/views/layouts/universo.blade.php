...
<head>
    ...
    <meta name="author" content="Kajuzi Digital">
...
<div class="wrapper">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand nav" id="brand">
                            <a href="{{ url( '/' ) }}"><img src="assets/img/logo.png" alt="brand"></a>
                        </div>
                    </div>
    ...
    <footer id="page-footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                        <aside class="logo">
                            <img src="assets/img/logo.png" class="vertical-center">
                        </aside>
                    </div><!-- /.col-md-3 -->
                    <div class="col-md-3 col-sm-4">
                        <aside>
                            ...
                            <address>
                                ...
                                <br>
                                <abbr title="Email">Email:</abbr> <a href="#">questions@learningpawn.com</a>
                            </address>
                        </aside>
                    </div><!-- /.col-md-3 -->
                    <div class="col-md-3 col-sm-4">
                    ...
                    <div class="col-md-3 col-sm-4">
                        <aside>
                            <header><h4>About Learning Pawn</h4></header>
        ...
        <section id="footer-bottom">
            <div class="container">
                <div class="footer-inner">
                    <div class="copyright">© Learning Pawn, All rights reserved</div><!-- /.copyright -->
                </div><!-- /.footer-inner -->
            </div><!-- /.container -->
